...
public class PrintStateOfGame {
	public static void makeFile(int times) {
		try {
			//出力先を作成する
			FileWriter fw = new FileWriter("D:\\work\\lab\\game\\yazirusi_game"+times+".txt", false);  //※１
	...
	public static void writeLap(int lap,int times) {
		try {
			//出力先を作成する
			FileWriter fw = new FileWriter("D:\\work\\lab\\game\\yazirusi_game"+times+".txt", true);  //※１
			PrintWriter pw = new PrintWriter(new BufferedWriter(fw));
